...
public class CodeServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			List l = cs.getAllObjectByHql("from AssetComputer where qysj between '2010-09-14' and '2011-1-1'");
			request.setAttribute("sbbh", l);
			request.getRequestDispatcher("/jsp/allCode.jsp").forward(
					request, response);
		} catch (Exception e) {
			e.printStackTrace();
		} finally {
